...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-repeat,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-indent-object,~/.vim/plugged/ReplaceWithRegister,~/.vim/plugged/jedi-vim,~/.vim/plugged/ale,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-commentary,~/.vim/plugged/ctrlp.vim,~/.vim/plugged/csv.vim,~/.vim/plugged/targets.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vim82/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/plugged/jedi-vim/after,~/.vim/after
set showcmd
set showmatch
set softtabstop=2
...
silent only
silent tabonly
cd ~/Workspace/Studia/PJATK/Sem4/PRO/Thesis\ /poc/scripts
...
silent! normal! zE
let s:l = 81 - ((22 * winheight(0) + 25) / 50)
